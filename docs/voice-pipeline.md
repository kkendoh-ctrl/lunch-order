...
| **5** | Watch 話者分離(WhisperX diarization)+ Reminders 連携 + エラー UI | 期限付き ToDo が Apple Reminders に、失敗ファイル再実行可 | 余裕がある時 | ✅ 5a (失敗追跡 + `retry`)・5b (`_reminders/todos.ics`)・5c (diarization 配線、要 HF_TOKEN) |
